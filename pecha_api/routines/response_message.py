...
DUPLICATE_SERIES = "A series can only appear once across the entire routine"
...
SOURCE_ID_REQUIRED = "source_id is required for PLAN, SERIES, RECITATION, and RECITATION_COLLECTION sessions"

...
DUPLICATE_PLAN = "A plan can only appear once per time block"
...
SOURCE_ID_REQUIRED = "source_id is required for PLAN, RECITATION, and RECITATION_COLLECTION sessions"

...
def schedule_event_reminders(event_id: UUID, start_date: datetime) -> None:
...
def reschedule_event_reminders(event_id: UUID, new_start_date: datetime) -> None:
    ...
    schedule_event_reminders(event_id, new_start_date)


def cancel_event_reminders(event_id: UUID) -> None:

...
@text_router.post(
    ...
    summary="Create text",
    description="Create a new text resource.",
)
...
async def get_versions_by_language(text_id: str, language: str) -> VersionsResponse:
    return await get_language_versions(text_id=text_id, language=language)

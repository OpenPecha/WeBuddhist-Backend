...
from .users_repository import get_user_by_email, update_user, get_user_by_username, find_user_by_username
...
def _generate_username_suggestions(base: str, count: int = 3) -> List[str]:
    """Generate unique username suggestions based on the requested username."""

...
if TYPE_CHECKING:
    from ..models.person_input_alt_names_type_0_item import PersonInputAltNamesType0Item
    from ..models.person_input_name import PersonInputName


T = TypeVar("T", bound="PersonInput")
...
class PersonInput:
    """
    Attributes:
        name (PersonInputName): Localized name (language code -> name)
        bdrc (None | str | Unset): BDRC identifier
        wiki (None | str | Unset): Wikidata identifier
        alt_names (list[PersonInputAltNamesType0Item] | None | Unset): Alternative localized names
    """

    name: PersonInputName
    bdrc: None | str | Unset = UNSET
    wiki: None | str | Unset = UNSET
    alt_names: list[PersonInputAltNamesType0Item] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        name = PersonInputName.from_dict(d.pop("name"))
        ...
        def _parse_alt_names(data: object) -> list[PersonInputAltNamesType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for alt_names_type_0_item_data in _alt_names_type_0:
                    alt_names_type_0_item = PersonInputAltNamesType0Item.from_dict(alt_names_type_0_item_data)
                ...
                pass
            return cast(list[PersonInputAltNamesType0Item] | None | Unset, data)
        ...
        person_input.additional_properties = d
        return person_input

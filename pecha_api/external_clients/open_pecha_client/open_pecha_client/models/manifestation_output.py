...
if TYPE_CHECKING:
    from ..models.manifestation_output_alt_incipit_titles_type_0_item import (
        ManifestationOutputAltIncipitTitlesType0Item,
    )
    from ..models.manifestation_output_incipit_title_type_0 import ManifestationOutputIncipitTitleType0


T = TypeVar("T", bound="ManifestationOutput")


@_attrs_define
class ManifestationOutput:
    """
    Attributes:
        id (str): Manifestation ID
        text_id (str): Associated text/expression ID
        type_ (ManifestationType): Type of manifestation/edition
        bdrc (None | str | Unset):
        wiki (None | str | Unset):
        source (None | str | Unset):
        colophon (None | str | Unset):
        incipit_title (ManifestationOutputIncipitTitleType0 | None | Unset):
        alt_incipit_titles (list[ManifestationOutputAltIncipitTitlesType0Item] | None | Unset):
    """
    ...
    incipit_title: ManifestationOutputIncipitTitleType0 | None | Unset = UNSET
    alt_incipit_titles: list[ManifestationOutputAltIncipitTitlesType0Item] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.incipit_title, Unset):
            incipit_title = UNSET
        elif isinstance(self.incipit_title, ManifestationOutputIncipitTitleType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_incipit_title(data: object) -> ManifestationOutputIncipitTitleType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                incipit_title_type_0 = ManifestationOutputIncipitTitleType0.from_dict(data)

                return incipit_title_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(ManifestationOutputIncipitTitleType0 | None | Unset, data)

        incipit_title = _parse_incipit_title(d.pop("incipit_title", UNSET))

        def _parse_alt_incipit_titles(
            data: object,
        ) -> list[ManifestationOutputAltIncipitTitlesType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for alt_incipit_titles_type_0_item_data in _alt_incipit_titles_type_0:
                    alt_incipit_titles_type_0_item = ManifestationOutputAltIncipitTitlesType0Item.from_dict(
                ...
                pass
            return cast(list[ManifestationOutputAltIncipitTitlesType0Item] | None | Unset, data)

        alt_incipit_titles = _parse_alt_incipit_titles(d.pop("alt_incipit_titles", UNSET))

        manifestation_output = cls(
            id=id,
            text_id=text_id,
            type_=type_,
            bdrc=bdrc,
        ...
        manifestation_output.additional_properties = d

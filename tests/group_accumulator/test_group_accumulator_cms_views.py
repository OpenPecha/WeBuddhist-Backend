...
class TestCreateGroupAccumulator:
    ...
    @patch('pecha_api.group_accumulator.group_accumulator_cms_views.create_group_accumulator_service')
...
class TestGetGroupAccumulators:
    ...
    @patch('pecha_api.group_accumulator.group_accumulator_cms_views.get_group_accumulators_service')
...
class TestUpdateGroupAccumulator:
    ...
    @patch('pecha_api.group_accumulator.group_accumulator_cms_views.update_group_accumulator_service')
...
class TestDeleteGroupAccumulator:
    ...
    @patch('pecha_api.group_accumulator.group_accumulator_cms_views.delete_group_accumulator_service')

...
async def test_create_new_sub_tasks_builds_and_saves_with_incremented_display_order():
    ...
    saved_items = [
        SimpleNamespace(
            id=uuid.uuid4(), content_type="TEXT", content="First", duration="10", display_order=6, source_text_id=None, pecha_segment_id=None, segment_id=None,
        ),
        SimpleNamespace(
            id=uuid.uuid4(), content_type="TEXT", content="Second", duration="10", display_order=7, source_text_id=None, pecha_segment_id=None, segment_id=None,
        ),
    ]
